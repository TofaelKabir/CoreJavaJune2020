...
public class MakePayment {
    public static void main(String[] args) {
       ...
       // PayByCreditCard payByCreditCard = new PayByCreditCard();
        ...
        System.out.println("\n------------------- Fifth Output: with lambda -------------------");
        PaymentSystem05 ps05 = new PaymentSystem05();
        ps05.payByCreditCard.processPaymentByCreditCard();


        PaymentSystem05.PayByCreditCardLambda.processPaymentByCreditCardLambda();
    }
}
