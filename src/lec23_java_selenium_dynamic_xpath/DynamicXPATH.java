package lec23_java_selenium_dynamic_xpath;
...
(//html tag [text() = 'inner text value' ])[index number]
 from mount sinai webite -- request an appointment --- (//a[@class='hidden-xs dropdown'])[3]
                            ...
                            driver.findElement(By.cssSelector(".srp vasq")); //IF CLASS USE . BEFORE THAT
                            driver.findElement(By.cssSelector("#srp vasq")); //if ID USE # BEFORE THAT
